...
public static class ReviewPromptManager
{
    ...
    private const double MINUTES_BEFORE_PROMPT = 240; // how many hours to wait before showing for the first time, or showing again
    private const int SHOW_DELAY_SECONDS = 15; // delay to show it after app launch
