    ...
    private Button CreatePresetButton(object presetData, Dictionary<string, string> currentInstalledHashes, bool isDefault)
    {
        ...
        if (presetData is LocalPresetData localPreset)
        {
            ...
            description = isCurrent
                ...
                : isDefault
                    ? "Click to rollback" + (RuntimeFlags.Set("SaidTheThingAboutHowDefaultPresetIsMade?") ? " — This preset was made using your latest game files upon your first attempt at installing a preset" : "")
                    : "Click to install";
        }
