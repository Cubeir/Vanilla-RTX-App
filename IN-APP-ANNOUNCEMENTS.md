...
# PSA
###
3.1 Update brings Dynamic Announcements to effectively communicate the latest information surrounding Minecraft RTX and app features. Enjoy!

###
RTX Reactor is coming to the Vanilla RTX App for free! This is an extremely time-consuming for me, so please consider supporting my projects on my Ko-Fi.
...
###
1.26.15:
Fog and atmosphere of many biomes has been overhauled across all three packs! Find detailed changelogs on CurseForge.

###
1.26.14 This update fixed and improved pretty good stuff! Can't remember what for the life of me though!
...
# DLSSAnnouncements
### A friendly note
P.S. The latest DLSS version isn't always the best, users report 310.5.3.0 is the latest that gives the clearest image, newer versions tend to be a bit blurry, thank me later and feel free to close this PSA.

# ResourcePackSelectionAnnouncements
### One time thingy, tutorial type of deal...
